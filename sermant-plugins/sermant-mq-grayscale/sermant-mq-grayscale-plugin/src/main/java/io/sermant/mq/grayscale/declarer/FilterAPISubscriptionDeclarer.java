...
public class FilterAPISubscriptionDeclarer extends MqAbstractDeclarer {
    ...
    private static final String[] METHOD_NAME = {"buildSubscriptionData", "build"};
    ...
    public InterceptDeclarer[] getInterceptDeclarers(ClassLoader classLoader) {
        return new InterceptDeclarer[]{
                InterceptDeclarer.build(MethodMatcher.nameContains(METHOD_NAME), new FilterAPISubscriptionInterceptor())
        };
    }
}
